...
@Slf4j
@Data
public class GetBlocksByHeightImpl extends SessionModules<BlockMessage> {
	...
	public String[] getCmds() {
		return new String[] { ActionCommand.GBS.name() };
	}
	...
	public void onPBPacket(final FramePacket pack, final BlockMessage pb, final CompleteHandler handler) {
		...
		try {
			BlockInfo[] bis = blockChainHelper.listBlockByHeight(pb.getHeight());
			if (bis != null) {
