...
public class BytesHelper {
	...
	public static final ByteString SUCCESS_BYTESTRING = ByteString.copyFrom(new byte[] { 0x01 });
	public static final ByteString ERROR_BYTESTRING = ByteString.copyFrom(new byte[] { (byte)0xff });

	public static final ByteString ZERO_BYTE_STRING = ByteString.copyFrom(EMPTY_BYTE_ARRAY);
	...
	public static byte[] copyToArray(BigInteger value) {
		byte[] src = BytesHelper.bigIntegerToBytes(value);
